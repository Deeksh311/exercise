...
mysql> select customer_number1,customer_firstname,customer_lastname,account_number from customer_master inner join account_master on customer_number=customer_number1 where extract(day from account_opening_date)>15 order by customer_number1,account_number;
+------------------+--------------------+-------------------+----------------+
| customer_number1 | customer_firstname | customer_lastname | account_number |
+------------------+--------------------+-------------------+----------------+
|                1 | Deeksha            | Killari           |            123 |
|                2 | Vandu              | Killari           |            768 |
|                3 | Harsha             | Majji             |            456 |
+------------------+--------------------+-------------------+----------------+
